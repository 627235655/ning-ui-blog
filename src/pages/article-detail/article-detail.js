...
class Catalogue {
	init = (selector) => {
		let node_list = [];
		let h_list = document.querySelectorAll(
						...
						>
							...
							<p className='article_preview-header_footer'>
								...
								<span className='m-l-md flex-center-box'>
									...
									></i>
									:{' '}
									{Math.ceil(data.articleContentLength / 400)}{' '}
									min
								</span>
								<span className='m-l-md flex-center-box'>
									<i
