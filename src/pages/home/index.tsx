...
const blogChart =
		'https://zongyuan.oss-cn-shenzhen.aliyuncs.com/ning-ui-blog/blog-chart.png',
	ningUi =
		'https://zongyuan.oss-cn-shenzhen.aliyuncs.com/ning-ui-blog/ning-ui.png',
	blogArticleList =
		'https://zongyuan.oss-cn-shenzhen.aliyuncs.com/ning-ui-blog/blog-article-list.png',
	blogAdmin =
		'https://zongyuan.oss-cn-shenzhen.aliyuncs.com/ning-ui-blog/blog-admin.png',
	antdAdmin =
		'https://zongyuan.oss-cn-shenzhen.aliyuncs.com/ning-ui-blog/antd-admin.png',
	blogHexo =
		'https://zongyuan.oss-cn-shenzhen.aliyuncs.com/ning-ui-blog/blog-hexo.png',
	onlineResume =
		'https://zongyuan.oss-cn-shenzhen.aliyuncs.com/ning-ui-blog/online-resume.png';
			...
			<div className='ning-container flex-col-box'>
				...
				<section className='overview'>
					<div className='profile-wrap'>
						...
						<Link
							to='/profile'
							className='ning-line-btn _fillet _fill blue'
						>
							关于我
						</Link>
					</div>
						...
						{workList.map((v) => (
							<li key={v.name}>
								...
								<div>
									<h2>
										{v.nameUrl ? (
											<a target='_blank' href={v.nameUrl}>
												{v.name}
											</a>
										) : (
											v.name
					...
					<div className='blog-desc-wrap'>
						<div className='blog-desc'>
							...
							<p>
								...
								，UI 基于自造框架{' '}
								<a href='/index/ning-ui/mind'>ning-ui</a>
								<br />
								知行合一，如是而已
							</p>
						</div>
							...
							<ul>
								<li className='flex-row-box flex-center-box'>
									<span className='_bold flex-center-box'>
										<i className='ning-icon icon-article m-r-sm'></i>
										Blogs
									</span>
									<Link
										to='/index/article-list'
										className='flex-center-box'
									>
										<i className='ning-icon icon-more m-r-sm'></i>
									</Link>
								</li>
