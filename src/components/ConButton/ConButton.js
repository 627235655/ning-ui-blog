    ...
    render() {
            return (
                ...
                <p className="ning-summary">
                    ...
                    <a href="http://localhost:4000/2018/06/14/color-btns/" className="_blue" target="_blank">详情</a>
                </p>
                ...
                <CodeBox
                    params={
                        {
                            type: 'html',
                            content: `<button className="ning-btn">基础按钮</button>
                                    <button className="ning-line-btn">线框按钮</button>
                                    <button className="ning-txt-btn">文字按钮</button>`,
                        }
                    }
                />
                <p>颜色</p>
                ...
                <CodeBox
                    params={
                        {
                            type: 'html',
                            content: `<button className="ning-btn _white">白色</button>
                            <button className="ning-btn _gray">灰色</button>
                            <button className="ning-btn _dark">黑色</button>
                            <button className="ning-btn _blue">蓝色</button>
                            <button className="ning-btn _green">绿色</button>
                            <button className="ning-btn _orange">橙色</button>
                            <button className="ning-btn _yellow">黄色</button>
                            <button className="ning-btn _purple">紫色</button>
                            <button className="ning-btn _red">红色</button>`,
                        }
                    }
                />
                ...
                <CodeBox
                    params={
                        {
                            type: 'html',
                            content: `<button className="ning-btn _sm">小按钮</button>
                            <button className="ning-btn _md">中按钮</button>
                            <button className="ning-btn _lg">大按钮</button>`,
                        }
                    }
                />
                <p>特效</p>
                ...
                <CodeBox
                    params={
                        {
                            type: 'html',
                            content: `<button className="ning-btn _shadow">阴影3D</button>
                            <button className="ning-btn _cover">背景滑动</button>
                            <button className="ning-btn _visional">虚影按钮</button>
                            <button className="ning-line-btn _fill">背景填充</button>`,
                        }
                    }
                />
                ...
                <CodeBox
                    params={
                        {
                            type: 'html',
                            content: `<a role="botton" tabIndex="0" className="ning-btn">a</a>
                            <span role="botton" tabIndex="0" className="ning-btn">span</span>
                            <label role="botton" tabIndex="0" className="ning-btn">label</label>
                            <div role="botton" tabIndex="0" className="ning-btn">div</div>`,
                        }
                    }
                />
                ...
                <CodeBox
                    params={
                        {
                            type: 'html',
                            content: `<button className="ning-btn" disabled>基础按钮</button>
                            <button className="ning-line-btn" disabled>线框按钮</button>
                            <button className="ning-txt-btn" disabled>文字按钮</button>`,
                        }
                    }
                />
            </div>
