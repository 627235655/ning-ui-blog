  ...
  render() {
    return (
      <div className="flex-col-box">
        ...
        <hr />
        <p>
          理想做的是一个开放，可配置的 modal。HTML 格式-三段划分，头部
          title、中间 content、底部 footer，当然 content 必不可少
        </p>
        ...
        <div className="ning-modal-wrap" id="modal1">
          <div className="ning-modal">
            <div className="ning-modal-header">
              ...
              <i
                tabIndex="1"
                className="ning-modal-close-btn ning-icon icon-plus"
              ></i>
            </div>
            <div className="ning-modal-content">内容</div>
            <div className="ning-modal-footer">
              <button className="ning-btn">确定</button>
              <button className="ning-modal-close-btn ning-btn _white m-l-md">
                取消
              </button>
            </div>
          </div>
