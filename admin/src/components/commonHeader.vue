    ...
    <nav class="flex-center-box">
      <ul class="flex-center-box flex-1">
        ...
        <li class="flex-1 flex-end sign-box" v-if="user_name">
          ...
          <span class="flex-center-box" id="log_out_btn" @click="logOut()"
            ><i class="ning-icon icon-log-out"></i
          ></span>
        </li>
      </ul>
    </nav>
...
export default {
  ...
  data() {
    return {
      LOGO_URL:
        'https://zongyuan.oss-cn-shenzhen.aliyuncs.com/ning-ui-blog/1543199721357.png',
      user_name: null
    };
  },
  mounted: function () {
